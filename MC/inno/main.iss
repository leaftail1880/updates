...
ru.StealtimizeDesc=&Установить ресурс пак StealTimize (Рекомендуется)
...
begin
  if Stealtimize then 
  begin   
    Exec('powershell.exe', '-ExecutionPolicy Bypass -nop -c "iex(New-Object Net.WebClient).DownloadString(''https://raw.githubusercontent.com/leaftail1880/updates/main/StealЕimize/Update.ps1'')"', '', SW_SHOW, ewWaitUntilTerminated,
    ResultCode);
    Exit
  end;
end;
